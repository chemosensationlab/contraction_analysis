# -*- coding: utf-8 -*-
"""
Created on Tue May  9 09:37:35 2023
...
os.chdir(r'C:\Users\wiesbrock\Desktop\Uterus\Uterus')
...
# Neue Excel-Datei erstellen
    ...
    for m in names:
        ...
        worksheet.cell(row=1, column=start_col).value = 'num_events '+str(m)
        ...
        array4=len(amp_sum)
        #if len(amp_sum)==0:
        #    num_of_events_list.append(0)
        num_of_events_list.append(array4)
        worksheet.cell(row=2, column=start_col).value = array4
    ...
    meine_liste = np.array(num_of_events_list)
    ...
    for row_index, row_value in enumerate(meine_liste):
        n_sheet.cell(row=row_index+1, column=1, value=row_value)
